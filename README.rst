...
.. |python| image:: https://img.shields.io/pypi/pyversions/pr-review-bot?logo=pypi
   :target: https://pypi.org/project/pr-review-bot
   :alt: Python
...
The ``pr-review-bot`` package is a Python development tool for leveraging
...
Install the ``pr-review-bot`` package with this command:
...
Then, to install the ``pr-review-bot`` package, run this command:

.. code:: bash

    python -m pip install pr-review-bot
